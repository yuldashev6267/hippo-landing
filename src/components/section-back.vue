            ...
            <div class="row">
                <div class="col-12 offset-0 col-lg-8 offset-lg-2 text-center">
                    <h1>Structures &amp; Layouts</h1>
                        <p>We did our best to create layouts for various needs that developers might have and best experiencefor users.
                        <br>They are clean and slick. They function well and look good at the same time.
                        </p>
                </div>
            </div>
            <div class="row pt-5">
                <div class="col-12 col-xs-6 col-sm-6 col-md-4 col-lg-3 mb-5"><img
                                            src="../assets/7.png"
